  ...
  if (tbRecords != null) {
    ...
    for (var i = 0; i < tbRecords.length; i++) {
      ...
      $("#tblRecords tbody").append("<tr>" +
        ...
        "  <td align='center'>" + rec.Height + "</td>" +
        "  <td align='center'>" + rec.Weight+ "</td>" +
        "  <td align='center'>" + rec.BMI +
        "</td>" +
        "  <td align='center'><a data-inline='true'  data-mini='true' data-role='button' href='#pageNewRecordForm' onclick='callEdit(" +
        i +
